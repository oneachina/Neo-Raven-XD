...
public interface IChatComponent extends Iterable<IChatComponent> {
    ...
    ChatComponentStyle appendSibling(IChatComponent var1);
    ...
    public static class Serializer implements JsonDeserializer<IChatComponent>, JsonSerializer<IChatComponent> {
        ...
        private void serializeChatStyle(ChatStyle p_serializeChatStyle_1_, JsonObject p_serializeChatStyle_2_, JsonSerializationContext p_serializeChatStyle_3_) {
            JsonElement jsonelement = p_serializeChatStyle_3_.serialize(p_serializeChatStyle_1_);
            if (jsonelement.isJsonObject()) {
                ...
                while(var6.hasNext()) {
                    ...
                    p_serializeChatStyle_2_.add((String)entry.getKey(), (JsonElement)entry.getValue());
                }
            }
        ...
        public static String componentToJson(IChatComponent p_componentToJson_0_) {
            return GSON.toJson(p_componentToJson_0_);
        }

        public static IChatComponent jsonToComponent(String p_jsonToComponent_0_) {
            return (IChatComponent)GSON.fromJson(p_jsonToComponent_0_, IChatComponent.class);
        }
