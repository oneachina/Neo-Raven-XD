...
public class ChatStyle {
    ...
    private static final ChatStyle rootStyle = new ChatStyle() {
        ...
        public ChatStyle setColor(EnumChatFormatting p_setColor_1_) {
            throw new UnsupportedOperationException();
        }

        public ChatStyle setBold(Boolean p_setBold_1_) {
            throw new UnsupportedOperationException();
        }

        public ChatStyle setItalic(Boolean p_setItalic_1_) {
            throw new UnsupportedOperationException();
        }

        public ChatStyle setStrikethrough(Boolean p_setStrikethrough_1_) {
            throw new UnsupportedOperationException();
        }

        public ChatStyle setUnderlined(Boolean p_setUnderlined_1_) {
            throw new UnsupportedOperationException();
        }

        public ChatStyle setObfuscated(Boolean p_setObfuscated_1_) {
            throw new UnsupportedOperationException();
        }

        public ChatStyle setChatClickEvent(ClickEvent p_setChatClickEvent_1_) {
            throw new UnsupportedOperationException();
        }

        public ChatStyle setChatHoverEvent(HoverEvent p_setChatHoverEvent_1_) {
            throw new UnsupportedOperationException();
        }

        public ChatStyle setParentStyle(ChatStyle p_setParentStyle_1_) {
            throw new UnsupportedOperationException();
        }
    ...
    public ChatStyle setColor(EnumChatFormatting p_setColor_1_) {
        this.color = p_setColor_1_;
        return this;
    }

    public ChatStyle setBold(Boolean p_setBold_1_) {
        this.bold = p_setBold_1_;
        return this;
    }

    public ChatStyle setItalic(Boolean p_setItalic_1_) {
        this.italic = p_setItalic_1_;
        return this;
    }

    public ChatStyle setStrikethrough(Boolean p_setStrikethrough_1_) {
        this.strikethrough = p_setStrikethrough_1_;
        return this;
    }

    public ChatStyle setUnderlined(Boolean p_setUnderlined_1_) {
        this.underlined = p_setUnderlined_1_;
        return this;
    }

    public ChatStyle setObfuscated(Boolean p_setObfuscated_1_) {
        this.obfuscated = p_setObfuscated_1_;
        return this;
    }

    public ChatStyle setChatClickEvent(ClickEvent p_setChatClickEvent_1_) {
        this.chatClickEvent = p_setChatClickEvent_1_;
        return this;
    }

    public ChatStyle setChatHoverEvent(HoverEvent p_setChatHoverEvent_1_) {
        this.chatHoverEvent = p_setChatHoverEvent_1_;
        return this;
    }

    public ChatStyle setInsertion(String p_setInsertion_1_) {
        this.insertion = p_setInsertion_1_;
        return this;
    }

    public ChatStyle setParentStyle(ChatStyle p_setParentStyle_1_) {
        this.parentStyle = p_setParentStyle_1_;
        return this;
    }
            ...
            if (p_deserialize_1_.isJsonObject()) {
                ...
                if (jsonobject == null) {
                    ...
                    if (jsonobject.has("hoverEvent")) {
                        ...
                        if (jsonobject2 != null) {
                            jsonprimitive2 = jsonobject2.getAsJsonPrimitive("action");
                            HoverEvent.Action hoverevent$action = jsonprimitive2 == null ? null : net.minecraft.util.text.event.HoverEvent.Action.getValueByCanonicalName(jsonprimitive2.getAsString());
                            ...
                            if (hoverevent$action != null && ichatcomponent != null && hoverevent$action.shouldAllowInChat()) {
                                chatstyle.chatHoverEvent = new HoverEvent(hoverevent$action, (ITextComponent) ichatcomponent);
                            }
                        }
                    }
